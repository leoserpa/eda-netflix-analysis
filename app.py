...
# Título principal
st.title("🎬 Dashboard de Análise Exploratória dos Dados da Netflix")
st.markdown("---")
...
with col2:
    ...
    # Storytelling simples
    st.markdown('<p style="font-size: 12px;"><em>Os gêneros mais populares na Netflix são Filmes Internacionais, Dramas e Comédias, refletindo o interesse do público por diversidade cultural e entretenimento.</em></p>', unsafe_allow_html=True)
